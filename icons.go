...
var (
	// Renders the Lucide icon 'a-arrow-down'.
	AArrowDown = templFuncs.AArrowDown
	// Renders the Lucide icon 'a-arrow-up'.
	AArrowUp = templFuncs.AArrowUp
	// Renders the Lucide icon 'a-large-small'.
	ALargeSmall = templFuncs.ALargeSmall
	// Renders the Lucide icon 'accessibility'.
	...
	Airplay = templFuncs.Airplay
	// Alias for 'AlarmClockCheck'(alarm-clock-check).Renders the Lucide icon 'alarm-check'
	AlarmCheck = templFuncs.AlarmClockCheck
	// Renders the Lucide icon 'alarm-clock'.
	AlarmClock = templFuncs.AlarmClock
	// Renders the Lucide icon 'alarm-clock-check'.
	AlarmClockCheck = templFuncs.AlarmClockCheck
	// Renders the Lucide icon 'alarm-clock-minus'.
	AlarmClockMinus = templFuncs.AlarmClockMinus
	// Renders the Lucide icon 'alarm-clock-off'.
	AlarmClockOff = templFuncs.AlarmClockOff
	// Renders the Lucide icon 'alarm-clock-plus'.
	AlarmClockPlus = templFuncs.AlarmClockPlus
	// Alias for 'AlarmClockMinus'(alarm-clock-minus).Renders the Lucide icon 'alarm-minus'
	AlarmMinus = templFuncs.AlarmClockMinus
	// Alias for 'AlarmClockPlus'(alarm-clock-plus).Renders the Lucide icon 'alarm-plus'
	AlarmPlus = templFuncs.AlarmClockPlus
	// Renders the Lucide icon 'alarm-smoke'.
	...
	AlignCenterHorizontal = templFuncs.AlignCenterHorizontal
	// Renders the Lucide icon 'align-center-vertical'.
	AlignCenterVertical = templFuncs.AlignCenterVertical
	// Renders the Lucide icon 'align-end-horizontal'.
	AlignEndHorizontal = templFuncs.AlignEndHorizontal
	// Renders the Lucide icon 'align-end-vertical'.
	AlignEndVertical = templFuncs.AlignEndVertical
	// Renders the Lucide icon 'align-horizontal-distribute-center'.
	AlignHorizontalDistributeCenter = templFuncs.AlignHorizontalDistributeCenter
	// Renders the Lucide icon 'align-horizontal-distribute-end'.
	AlignHorizontalDistributeEnd = templFuncs.AlignHorizontalDistributeEnd
	// Renders the Lucide icon 'align-horizontal-distribute-start'.
	AlignHorizontalDistributeStart = templFuncs.AlignHorizontalDistributeStart
	// Renders the Lucide icon 'align-horizontal-justify-center'.
	AlignHorizontalJustifyCenter = templFuncs.AlignHorizontalJustifyCenter
	// Renders the Lucide icon 'align-horizontal-justify-end'.
	AlignHorizontalJustifyEnd = templFuncs.AlignHorizontalJustifyEnd
	// Renders the Lucide icon 'align-horizontal-justify-start'.
	AlignHorizontalJustifyStart = templFuncs.AlignHorizontalJustifyStart
	// Renders the Lucide icon 'align-horizontal-space-around'.
	AlignHorizontalSpaceAround = templFuncs.AlignHorizontalSpaceAround
	// Renders the Lucide icon 'align-horizontal-space-between'.
	AlignHorizontalSpaceBetween = templFuncs.AlignHorizontalSpaceBetween
	// Renders the Lucide icon 'align-justify'.
	AlignJustify = templFuncs.AlignJustify
	// Renders the Lucide icon 'align-left'.
	AlignLeft = templFuncs.AlignLeft
	// Renders the Lucide icon 'align-right'.
	AlignRight = templFuncs.AlignRight
	// Renders the Lucide icon 'align-start-horizontal'.
	AlignStartHorizontal = templFuncs.AlignStartHorizontal
	// Renders the Lucide icon 'align-start-vertical'.
	AlignStartVertical = templFuncs.AlignStartVertical
	// Renders the Lucide icon 'align-vertical-distribute-center'.
	AlignVerticalDistributeCenter = templFuncs.AlignVerticalDistributeCenter
	// Renders the Lucide icon 'align-vertical-distribute-end'.
	AlignVerticalDistributeEnd = templFuncs.AlignVerticalDistributeEnd
	// Renders the Lucide icon 'align-vertical-distribute-start'.
	AlignVerticalDistributeStart = templFuncs.AlignVerticalDistributeStart
	// Renders the Lucide icon 'align-vertical-justify-center'.
	AlignVerticalJustifyCenter = templFuncs.AlignVerticalJustifyCenter
	// Renders the Lucide icon 'align-vertical-justify-end'.
	AlignVerticalJustifyEnd = templFuncs.AlignVerticalJustifyEnd
	// Renders the Lucide icon 'align-vertical-justify-start'.
	AlignVerticalJustifyStart = templFuncs.AlignVerticalJustifyStart
	// Renders the Lucide icon 'align-vertical-space-around'.
	...
	Angry = templFuncs.Angry
	// Renders the Lucide icon 'annoyed'.
	Annoyed = templFuncs.Annoyed
	// Renders the Lucide icon 'antenna'.
	Antenna = templFuncs.Antenna
	// Renders the Lucide icon 'anvil'.
	Anvil = templFuncs.Anvil
	// Renders the Lucide icon 'aperture'.
	...
	Archive = templFuncs.Archive
	// Renders the Lucide icon 'archive-restore'.
	...
	ArrowBigDown = templFuncs.ArrowBigDown
	// Renders the Lucide icon 'arrow-big-down-dash'.
	ArrowBigDownDash = templFuncs.ArrowBigDownDash
	// Renders the Lucide icon 'arrow-big-left'.
	ArrowBigLeft = templFuncs.ArrowBigLeft
	// Renders the Lucide icon 'arrow-big-left-dash'.
	ArrowBigLeftDash = templFuncs.ArrowBigLeftDash
	// Renders the Lucide icon 'arrow-big-right'.
	ArrowBigRight = templFuncs.ArrowBigRight
	// Renders the Lucide icon 'arrow-big-right-dash'.
	ArrowBigRightDash = templFuncs.ArrowBigRightDash
	// Renders the Lucide icon 'arrow-big-up'.
	ArrowBigUp = templFuncs.ArrowBigUp
	// Renders the Lucide icon 'arrow-big-up-dash'.
	ArrowBigUpDash = templFuncs.ArrowBigUpDash
	// Renders the Lucide icon 'arrow-down'.
	ArrowDown = templFuncs.ArrowDown
	// Renders the Lucide icon 'arrow-down-0-1'.
	ArrowDown01 = templFuncs.ArrowDown01
	// Renders the Lucide icon 'arrow-down-1-0'.
	ArrowDown10 = templFuncs.ArrowDown10
	// Renders the Lucide icon 'arrow-down-a-z'.
	...
	ArrowDownToLine = templFuncs.ArrowDownToLine
	// Renders the Lucide icon 'arrow-down-up'.
	ArrowDownUp = templFuncs.ArrowDownUp
	// Renders the Lucide icon 'arrow-down-wide-narrow'.
	ArrowDownWideNarrow = templFuncs.ArrowDownWideNarrow
	// Renders the Lucide icon 'arrow-down-z-a'.
	ArrowDownZA = templFuncs.ArrowDownZA
	// Alias for 'ArrowDownZA'(arrow-down-z-a).Renders the Lucide icon 'arrow-down-za'
	ArrowDownZa = templFuncs.ArrowDownZA
	...
	ArrowUp = templFuncs.ArrowUp
	// Renders the Lucide icon 'arrow-up-0-1'.
	ArrowUp01 = templFuncs.ArrowUp01
	// Renders the Lucide icon 'arrow-up-1-0'.
	ArrowUp10 = templFuncs.ArrowUp10
	// Renders the Lucide icon 'arrow-up-a-z'.
	...
	ArrowUpFromDot = templFuncs.ArrowUpFromDot
	// Renders the Lucide icon 'arrow-up-from-line'.
	...
	ArrowUpWideNarrow = templFuncs.ArrowUpWideNarrow
	// Renders the Lucide icon 'arrow-up-z-a'.
	ArrowUpZA = templFuncs.ArrowUpZA
	// Alias for 'ArrowUpZA'(arrow-up-z-a).Renders the Lucide icon 'arrow-up-za'
	ArrowUpZa = templFuncs.ArrowUpZA
	// Renders the Lucide icon 'arrows-up-from-line'.
	...
	Atom = templFuncs.Atom
	// Renders the Lucide icon 'audio-lines'.
	AudioLines = templFuncs.AudioLines
	// Renders the Lucide icon 'audio-waveform'.
	AudioWaveform = templFuncs.AudioWaveform
	// Renders the Lucide icon 'award'.
	Award = templFuncs.Award
	// Renders the Lucide icon 'axe'.
	Axe = templFuncs.Axe
	// Renders the Lucide icon 'axis-3d'.
	Axis3D = templFuncs.Axis3D
	// Renders the Lucide icon 'baby'.
	Baby = templFuncs.Baby
	// Renders the Lucide icon 'backpack'.
	Backpack = templFuncs.Backpack
	// Renders the Lucide icon 'badge'.
	Badge = templFuncs.Badge
	// Renders the Lucide icon 'badge-alert'.
	BadgeAlert = templFuncs.BadgeAlert
	// Renders the Lucide icon 'badge-cent'.
	BadgeCent = templFuncs.BadgeCent
	// Renders the Lucide icon 'badge-check'.
	BadgeCheck = templFuncs.BadgeCheck
	// Renders the Lucide icon 'badge-dollar-sign'.
	BadgeDollarSign = templFuncs.BadgeDollarSign
	// Renders the Lucide icon 'badge-euro'.
	BadgeEuro = templFuncs.BadgeEuro
	// Renders the Lucide icon 'badge-help'.
	BadgeHelp = templFuncs.BadgeHelp
	// Renders the Lucide icon 'badge-indian-rupee'.
	BadgeIndianRupee = templFuncs.BadgeIndianRupee
	// Renders the Lucide icon 'badge-info'.
	BadgeInfo = templFuncs.BadgeInfo
	// Renders the Lucide icon 'badge-japanese-yen'.
	BadgeJapaneseYen = templFuncs.BadgeJapaneseYen
	// Renders the Lucide icon 'badge-minus'.
	BadgeMinus = templFuncs.BadgeMinus
	// Renders the Lucide icon 'badge-percent'.
	BadgePercent = templFuncs.BadgePercent
	// Renders the Lucide icon 'badge-plus'.
	BadgePlus = templFuncs.BadgePlus
	// Renders the Lucide icon 'badge-pound-sterling'.
	BadgePoundSterling = templFuncs.BadgePoundSterling
	// Renders the Lucide icon 'badge-russian-ruble'.
	BadgeRussianRuble = templFuncs.BadgeRussianRuble
	// Renders the Lucide icon 'badge-swiss-franc'.
	BadgeSwissFranc = templFuncs.BadgeSwissFranc
	// Renders the Lucide icon 'badge-x'.
	BadgeX = templFuncs.BadgeX
	// Renders the Lucide icon 'baggage-claim'.
	BaggageClaim = templFuncs.BaggageClaim
	// Renders the Lucide icon 'ban'.
	Ban = templFuncs.Ban
	...
	Baseline = templFuncs.Baseline
	// Renders the Lucide icon 'bath'.
	Bath = templFuncs.Bath
	// Renders the Lucide icon 'battery'.
	Battery = templFuncs.Battery
	// Renders the Lucide icon 'battery-charging'.
	BatteryCharging = templFuncs.BatteryCharging
	// Renders the Lucide icon 'battery-full'.
	BatteryFull = templFuncs.BatteryFull
	// Renders the Lucide icon 'battery-low'.
	...
	Beaker = templFuncs.Beaker
	// Renders the Lucide icon 'bean'.
	Bean = templFuncs.Bean
	// Renders the Lucide icon 'bean-off'.
	BeanOff = templFuncs.BeanOff
	// Renders the Lucide icon 'bed'.
	Bed = templFuncs.Bed
	// Renders the Lucide icon 'bed-double'.
	BedDouble = templFuncs.BedDouble
	// Renders the Lucide icon 'bed-single'.
	BedSingle = templFuncs.BedSingle
	// Renders the Lucide icon 'beef'.
	...
	BellDot = templFuncs.BellDot
	// Renders the Lucide icon 'bell-electric'.
	BellElectric = templFuncs.BellElectric
	// Renders the Lucide icon 'bell-minus'.
	BellMinus = templFuncs.BellMinus
	// Renders the Lucide icon 'bell-off'.
	BellOff = templFuncs.BellOff
	// Renders the Lucide icon 'bell-plus'.
	...
	Blocks = templFuncs.Blocks
	// Renders the Lucide icon 'bluetooth'.
	Bluetooth = templFuncs.Bluetooth
	// Renders the Lucide icon 'bluetooth-connected'.
	BluetoothConnected = templFuncs.BluetoothConnected
	// Renders the Lucide icon 'bluetooth-off'.
	BluetoothOff = templFuncs.BluetoothOff
	// Renders the Lucide icon 'bluetooth-searching'.
	BluetoothSearching = templFuncs.BluetoothSearching
	// Renders the Lucide icon 'bold'.
	Bold = templFuncs.Bold
	// Renders the Lucide icon 'bolt'.
	Bolt = templFuncs.Bolt
	// Renders the Lucide icon 'bomb'.
	Bomb = templFuncs.Bomb
	// Renders the Lucide icon 'bone'.
	Bone = templFuncs.Bone
	// Renders the Lucide icon 'book'.
	Book = templFuncs.Book
	// Renders the Lucide icon 'book-a'.
	BookA = templFuncs.BookA
	// Renders the Lucide icon 'book-audio'.
	BookAudio = templFuncs.BookAudio
	// Renders the Lucide icon 'book-check'.
	BookCheck = templFuncs.BookCheck
	// Renders the Lucide icon 'book-copy'.
	BookCopy = templFuncs.BookCopy
	// Renders the Lucide icon 'book-dashed'.
	BookDashed = templFuncs.BookDashed
	// Renders the Lucide icon 'book-down'.
	BookDown = templFuncs.BookDown
	// Renders the Lucide icon 'book-headphones'.
	BookHeadphones = templFuncs.BookHeadphones
	// Renders the Lucide icon 'book-heart'.
	BookHeart = templFuncs.BookHeart
	// Renders the Lucide icon 'book-image'.
	BookImage = templFuncs.BookImage
	// Renders the Lucide icon 'book-key'.
	BookKey = templFuncs.BookKey
	// Renders the Lucide icon 'book-lock'.
	BookLock = templFuncs.BookLock
	// Renders the Lucide icon 'book-marked'.
	BookMarked = templFuncs.BookMarked
	// Renders the Lucide icon 'book-minus'.
	BookMinus = templFuncs.BookMinus
	// Renders the Lucide icon 'book-open'.
	BookOpen = templFuncs.BookOpen
	// Renders the Lucide icon 'book-open-check'.
	BookOpenCheck = templFuncs.BookOpenCheck
	// Renders the Lucide icon 'book-open-text'.
	BookOpenText = templFuncs.BookOpenText
	// Renders the Lucide icon 'book-plus'.
	BookPlus = templFuncs.BookPlus
	// Alias for 'BookDashed'(book-dashed).Renders the Lucide icon 'book-template'
	BookTemplate = templFuncs.BookDashed
	// Renders the Lucide icon 'book-text'.
	BookText = templFuncs.BookText
	// Renders the Lucide icon 'book-type'.
	BookType = templFuncs.BookType
	// Renders the Lucide icon 'book-up'.
	BookUp = templFuncs.BookUp
	// Renders the Lucide icon 'book-up-2'.
	BookUp2 = templFuncs.BookUp2
	// Renders the Lucide icon 'book-user'.
	BookUser = templFuncs.BookUser
	// Renders the Lucide icon 'book-x'.
	BookX = templFuncs.BookX
	// Renders the Lucide icon 'bookmark'.
	Bookmark = templFuncs.Bookmark
	// Renders the Lucide icon 'bookmark-check'.
	BookmarkCheck = templFuncs.BookmarkCheck
	// Renders the Lucide icon 'bookmark-minus'.
	BookmarkMinus = templFuncs.BookmarkMinus
	// Renders the Lucide icon 'bookmark-plus'.
	BookmarkPlus = templFuncs.BookmarkPlus
	// Renders the Lucide icon 'bookmark-x'.
	BookmarkX = templFuncs.BookmarkX
	// Renders the Lucide icon 'boom-box'.
	...
	Braces = templFuncs.Braces
	// Renders the Lucide icon 'brackets'.
	Brackets = templFuncs.Brackets
	// Renders the Lucide icon 'brain'.
	Brain = templFuncs.Brain
	// Renders the Lucide icon 'brain-circuit'.
	BrainCircuit = templFuncs.BrainCircuit
	// Renders the Lucide icon 'brain-cog'.
	BrainCog = templFuncs.BrainCog
	// Renders the Lucide icon 'brick-wall'.
	...
	Brush = templFuncs.Brush
	// Renders the Lucide icon 'bug'.
	Bug = templFuncs.Bug
	// Renders the Lucide icon 'bug-off'.
	BugOff = templFuncs.BugOff
	// Renders the Lucide icon 'bug-play'.
	BugPlay = templFuncs.BugPlay
	// Renders the Lucide icon 'building'.
	Building = templFuncs.Building
	// Renders the Lucide icon 'building-2'.
	Building2 = templFuncs.Building2
	// Renders the Lucide icon 'bus'.
	Bus = templFuncs.Bus
	// Renders the Lucide icon 'bus-front'.
	BusFront = templFuncs.BusFront
	// Renders the Lucide icon 'cable'.
	Cable = templFuncs.Cable
	// Renders the Lucide icon 'cable-car'.
	CableCar = templFuncs.CableCar
	// Renders the Lucide icon 'cake'.
	Cake = templFuncs.Cake
	// Renders the Lucide icon 'cake-slice'.
	CakeSlice = templFuncs.CakeSlice
	// Renders the Lucide icon 'calculator'.
	...
	CalendarX2 = templFuncs.CalendarX2
	// Renders the Lucide icon 'camera'.
	...
	CarFront = templFuncs.CarFront
	// Renders the Lucide icon 'car-taxi-front'.
	CarTaxiFront = templFuncs.CarTaxiFront
	// Renders the Lucide icon 'caravan'.
	Caravan = templFuncs.Caravan
	// Renders the Lucide icon 'carrot'.
	Carrot = templFuncs.Carrot
	// Renders the Lucide icon 'case-lower'.
	CaseLower = templFuncs.CaseLower
	// Renders the Lucide icon 'case-sensitive'.
	CaseSensitive = templFuncs.CaseSensitive
	// Renders the Lucide icon 'case-upper'.
	CaseUpper = templFuncs.CaseUpper
	// Renders the Lucide icon 'cassette-tape'.
	CassetteTape = templFuncs.CassetteTape
	// Renders the Lucide icon 'cast'.
	Cast = templFuncs.Cast
	// Renders the Lucide icon 'castle'.
	Castle = templFuncs.Castle
	// Renders the Lucide icon 'cat'.
	Cat = templFuncs.Cat
	...
	ChevronsDownUp = templFuncs.ChevronsDownUp
	// Renders the Lucide icon 'chevrons-left'.
	...
	ChevronsRightLeft = templFuncs.ChevronsRightLeft
	// Renders the Lucide icon 'chevrons-up'.
	ChevronsUp = templFuncs.ChevronsUp
	// Renders the Lucide icon 'chevrons-up-down'.
	ChevronsUpDown = templFuncs.ChevronsUpDown
	// Renders the Lucide icon 'chrome'.
	Chrome = templFuncs.Chrome
	// Renders the Lucide icon 'church'.
	Church = templFuncs.Church
	// Renders the Lucide icon 'cigarette'.
	Cigarette = templFuncs.Cigarette
	// Renders the Lucide icon 'cigarette-off'.
	...
	CircleDot = templFuncs.CircleDot
	// Renders the Lucide icon 'circle-dot-dashed'.
	CircleDotDashed = templFuncs.CircleDotDashed
	// Renders the Lucide icon 'circle-ellipsis'.
	...
	Citrus = templFuncs.Citrus
	// Renders the Lucide icon 'clapperboard'.
	Clapperboard = templFuncs.Clapperboard
	// Renders the Lucide icon 'clipboard'.
	Clipboard = templFuncs.Clipboard
	// Renders the Lucide icon 'clipboard-check'.
	...
	ClipboardX = templFuncs.ClipboardX
	// Renders the Lucide icon 'clock'.
	Clock = templFuncs.Clock
	// Renders the Lucide icon 'clock-1'.
	Clock1 = templFuncs.Clock1
	// Renders the Lucide icon 'clock-10'.
	Clock10 = templFuncs.Clock10
	// Renders the Lucide icon 'clock-11'.
	Clock11 = templFuncs.Clock11
	// Renders the Lucide icon 'clock-12'.
	Clock12 = templFuncs.Clock12
	// Renders the Lucide icon 'clock-2'.
	Clock2 = templFuncs.Clock2
	// Renders the Lucide icon 'clock-3'.
	Clock3 = templFuncs.Clock3
	// Renders the Lucide icon 'clock-4'.
	Clock4 = templFuncs.Clock4
	// Renders the Lucide icon 'clock-5'.
	Clock5 = templFuncs.Clock5
	// Renders the Lucide icon 'clock-6'.
	Clock6 = templFuncs.Clock6
	// Renders the Lucide icon 'clock-7'.
	Clock7 = templFuncs.Clock7
	// Renders the Lucide icon 'clock-8'.
	...
	CloudFog = templFuncs.CloudFog
	// Renders the Lucide icon 'cloud-hail'.
	CloudHail = templFuncs.CloudHail
	// Renders the Lucide icon 'cloud-lightning'.
	CloudLightning = templFuncs.CloudLightning
	// Renders the Lucide icon 'cloud-moon'.
	CloudMoon = templFuncs.CloudMoon
	// Renders the Lucide icon 'cloud-moon-rain'.
	CloudMoonRain = templFuncs.CloudMoonRain
	// Renders the Lucide icon 'cloud-off'.
	CloudOff = templFuncs.CloudOff
	// Renders the Lucide icon 'cloud-rain'.
	CloudRain = templFuncs.CloudRain
	// Renders the Lucide icon 'cloud-rain-wind'.
	CloudRainWind = templFuncs.CloudRainWind
	// Renders the Lucide icon 'cloud-snow'.
	CloudSnow = templFuncs.CloudSnow
	// Renders the Lucide icon 'cloud-sun'.
	...
	Clover = templFuncs.Clover
	// Renders the Lucide icon 'club'.
	...
	Codesandbox = templFuncs.Codesandbox
	// Renders the Lucide icon 'coffee'.
	Coffee = templFuncs.Coffee
	// Renders the Lucide icon 'cog'.
	Cog = templFuncs.Cog
	// Renders the Lucide icon 'coins'.
	Coins = templFuncs.Coins
	// Alias for 'Columns2'(columns-2).Renders the Lucide icon 'columns'
	Columns = templFuncs.Columns2
	// Renders the Lucide icon 'columns-2'.
	Columns2 = templFuncs.Columns2
	// Renders the Lucide icon 'columns-3'.
	Columns3 = templFuncs.Columns3
	// Renders the Lucide icon 'columns-4'.
	Columns4 = templFuncs.Columns4
	// Renders the Lucide icon 'combine'.
	Combine = templFuncs.Combine
	// Renders the Lucide icon 'command'.
	Command = templFuncs.Command
	// Renders the Lucide icon 'compass'.
	Compass = templFuncs.Compass
	// Renders the Lucide icon 'component'.
	Component = templFuncs.Component
	// Renders the Lucide icon 'computer'.
	Computer = templFuncs.Computer
	// Renders the Lucide icon 'concierge-bell'.
	ConciergeBell = templFuncs.ConciergeBell
	// Renders the Lucide icon 'cone'.
	Cone = templFuncs.Cone
	// Renders the Lucide icon 'construction'.
	...
	Contrast = templFuncs.Contrast
	// Renders the Lucide icon 'cookie'.
	Cookie = templFuncs.Cookie
	// Renders the Lucide icon 'cooking-pot'.
	CookingPot = templFuncs.CookingPot
	// Renders the Lucide icon 'copy'.
	Copy = templFuncs.Copy
	// Renders the Lucide icon 'copy-check'.
	CopyCheck = templFuncs.CopyCheck
	// Renders the Lucide icon 'copy-minus'.
	CopyMinus = templFuncs.CopyMinus
	// Renders the Lucide icon 'copy-plus'.
	CopyPlus = templFuncs.CopyPlus
	// Renders the Lucide icon 'copy-slash'.
	CopySlash = templFuncs.CopySlash
	// Renders the Lucide icon 'copy-x'.
	CopyX = templFuncs.CopyX
	// Renders the Lucide icon 'copyleft'.
	Copyleft = templFuncs.Copyleft
	// Renders the Lucide icon 'copyright'.
	Copyright = templFuncs.Copyright
	// Renders the Lucide icon 'corner-down-left'.
	CornerDownLeft = templFuncs.CornerDownLeft
	// Renders the Lucide icon 'corner-down-right'.
	CornerDownRight = templFuncs.CornerDownRight
	// Renders the Lucide icon 'corner-left-down'.
	CornerLeftDown = templFuncs.CornerLeftDown
	// Renders the Lucide icon 'corner-left-up'.
	CornerLeftUp = templFuncs.CornerLeftUp
	// Renders the Lucide icon 'corner-right-down'.
	CornerRightDown = templFuncs.CornerRightDown
	// Renders the Lucide icon 'corner-right-up'.
	CornerRightUp = templFuncs.CornerRightUp
	// Renders the Lucide icon 'corner-up-left'.
	CornerUpLeft = templFuncs.CornerUpLeft
	// Renders the Lucide icon 'corner-up-right'.
	CornerUpRight = templFuncs.CornerUpRight
	// Renders the Lucide icon 'cpu'.
	Cpu = templFuncs.Cpu
	// Renders the Lucide icon 'creative-commons'.
	CreativeCommons = templFuncs.CreativeCommons
	// Renders the Lucide icon 'credit-card'.
	CreditCard = templFuncs.CreditCard
	// Renders the Lucide icon 'croissant'.
	Croissant = templFuncs.Croissant
	// Renders the Lucide icon 'crop'.
	Crop = templFuncs.Crop
	// Renders the Lucide icon 'cross'.
	Cross = templFuncs.Cross
	// Renders the Lucide icon 'crosshair'.
	Crosshair = templFuncs.Crosshair
	// Renders the Lucide icon 'crown'.
	Crown = templFuncs.Crown
	// Renders the Lucide icon 'cuboid'.
	Cuboid = templFuncs.Cuboid
	// Renders the Lucide icon 'cup-soda'.
	CupSoda = templFuncs.CupSoda
	// Alias for 'Braces'(braces).Renders the Lucide icon 'curly-braces'
	CurlyBraces = templFuncs.Braces
	// Renders the Lucide icon 'currency'.
	...
	DatabaseBackup = templFuncs.DatabaseBackup
	// Renders the Lucide icon 'database-zap'.
	DatabaseZap = templFuncs.DatabaseZap
	// Renders the Lucide icon 'delete'.
	Delete = templFuncs.Delete
	// Renders the Lucide icon 'dessert'.
	Dessert = templFuncs.Dessert
	// Renders the Lucide icon 'diameter'.
	...
	Dice2 = templFuncs.Dice2
	// Renders the Lucide icon 'dice-3'.
	Dice3 = templFuncs.Dice3
	// Renders the Lucide icon 'dice-4'.
	Dice4 = templFuncs.Dice4
	// Renders the Lucide icon 'dice-5'.
	Dice5 = templFuncs.Dice5
	// Renders the Lucide icon 'dice-6'.
	Dice6 = templFuncs.Dice6
	// Renders the Lucide icon 'dices'.
	Dices = templFuncs.Dices
	// Renders the Lucide icon 'diff'.
	Diff = templFuncs.Diff
	// Renders the Lucide icon 'disc'.
	Disc = templFuncs.Disc
	// Renders the Lucide icon 'disc-2'.
	Disc2 = templFuncs.Disc2
	// Renders the Lucide icon 'disc-3'.
	Disc3 = templFuncs.Disc3
	// Renders the Lucide icon 'disc-album'.
	...
	DollarSign = templFuncs.DollarSign
	// Renders the Lucide icon 'donut'.
	Donut = templFuncs.Donut
	// Renders the Lucide icon 'door-closed'.
	DoorClosed = templFuncs.DoorClosed
	// Renders the Lucide icon 'door-open'.
	...
	Drama = templFuncs.Drama
	// Renders the Lucide icon 'dribbble'.
	Dribbble = templFuncs.Dribbble
	// Renders the Lucide icon 'drill'.
	...
	Drum = templFuncs.Drum
	// Renders the Lucide icon 'drumstick'.
	Drumstick = templFuncs.Drumstick
	// Renders the Lucide icon 'dumbbell'.
	Dumbbell = templFuncs.Dumbbell
	// Renders the Lucide icon 'ear'.
	Ear = templFuncs.Ear
	...
	Edit3 = templFuncs.PenLine
	// Renders the Lucide icon 'egg'.
	Egg = templFuncs.Egg
	// Renders the Lucide icon 'egg-fried'.
	...
	Expand = templFuncs.Expand
	// Renders the Lucide icon 'external-link'.
	...
	Facebook = templFuncs.Facebook
	// Renders the Lucide icon 'factory'.
	Factory = templFuncs.Factory
	// Renders the Lucide icon 'fan'.
	Fan = templFuncs.Fan
	// Renders the Lucide icon 'fast-forward'.
	FastForward = templFuncs.FastForward
	// Renders the Lucide icon 'feather'.
	Feather = templFuncs.Feather
	// Renders the Lucide icon 'fence'.
	Fence = templFuncs.Fence
	// Renders the Lucide icon 'ferris-wheel'.
	FerrisWheel = templFuncs.FerrisWheel
	// Renders the Lucide icon 'figma'.
	Figma = templFuncs.Figma
	// Renders the Lucide icon 'file'.
	File = templFuncs.File
	// Renders the Lucide icon 'file-archive'.
	FileArchive = templFuncs.FileArchive
	// Renders the Lucide icon 'file-audio'.
	FileAudio = templFuncs.FileAudio
	// Renders the Lucide icon 'file-audio-2'.
	FileAudio2 = templFuncs.FileAudio2
	// Renders the Lucide icon 'file-axis-3d'.
	FileAxis3D = templFuncs.FileAxis3D
	// Renders the Lucide icon 'file-badge'.
	...
	FileCheck2 = templFuncs.FileCheck2
	// Renders the Lucide icon 'file-clock'.
	FileClock = templFuncs.FileClock
	// Renders the Lucide icon 'file-code'.
	FileCode = templFuncs.FileCode
	// Renders the Lucide icon 'file-code-2'.
	FileCode2 = templFuncs.FileCode2
	// Renders the Lucide icon 'file-cog'.
	FileCog = templFuncs.FileCog
	// Alias for 'FileCog'(file-cog).Renders the Lucide icon 'file-cog-2'
	FileCog2 = templFuncs.FileCog
	// Renders the Lucide icon 'file-diff'.
	FileDiff = templFuncs.FileDiff
	// Renders the Lucide icon 'file-digit'.
	...
	FileImage = templFuncs.FileImage
	// Renders the Lucide icon 'file-input'.
	FileInput = templFuncs.FileInput
	// Renders the Lucide icon 'file-json'.
	FileJson = templFuncs.FileJson
	// Renders the Lucide icon 'file-json-2'.
	FileJson2 = templFuncs.FileJson2
	// Renders the Lucide icon 'file-key'.
	...
	FileLock2 = templFuncs.FileLock2
	// Renders the Lucide icon 'file-minus'.
	FileMinus = templFuncs.FileMinus
	// Renders the Lucide icon 'file-minus-2'.
	FileMinus2 = templFuncs.FileMinus2
	// Renders the Lucide icon 'file-music'.
	...
	FilePlus2 = templFuncs.FilePlus2
	// Renders the Lucide icon 'file-question'.
	FileQuestion = templFuncs.FileQuestion
	// Renders the Lucide icon 'file-scan'.
	FileScan = templFuncs.FileScan
	// Renders the Lucide icon 'file-search'.
	...
	FileStack = templFuncs.FileStack
	// Renders the Lucide icon 'file-symlink'.
	FileSymlink = templFuncs.FileSymlink
	// Renders the Lucide icon 'file-terminal'.
	FileTerminal = templFuncs.FileTerminal
	// Renders the Lucide icon 'file-text'.
	FileText = templFuncs.FileText
	// Renders the Lucide icon 'file-type'.
	FileType = templFuncs.FileType
	// Renders the Lucide icon 'file-type-2'.
	...
	FileVideo2 = templFuncs.FileVideo2
	// Renders the Lucide icon 'file-volume'.
	FileVolume = templFuncs.FileVolume
	// Renders the Lucide icon 'file-volume-2'.
	FileVolume2 = templFuncs.FileVolume2
	// Renders the Lucide icon 'file-warning'.
	FileWarning = templFuncs.FileWarning
	// Renders the Lucide icon 'file-x'.
	FileX = templFuncs.FileX
	// Renders the Lucide icon 'file-x-2'.
	FileX2 = templFuncs.FileX2
	// Renders the Lucide icon 'files'.
	Files = templFuncs.Files
	// Renders the Lucide icon 'film'.
	Film = templFuncs.Film
	// Renders the Lucide icon 'filter'.
	Filter = templFuncs.Filter
	// Renders the Lucide icon 'filter-x'.
	FilterX = templFuncs.FilterX
	// Renders the Lucide icon 'fingerprint'.
	Fingerprint = templFuncs.Fingerprint
	// Renders the Lucide icon 'fire-extinguisher'.
	FireExtinguisher = templFuncs.FireExtinguisher
	// Renders the Lucide icon 'fish'.
	Fish = templFuncs.Fish
	// Renders the Lucide icon 'fish-off'.
	FishOff = templFuncs.FishOff
	// Renders the Lucide icon 'fish-symbol'.
	FishSymbol = templFuncs.FishSymbol
	// Renders the Lucide icon 'flag'.
	Flag = templFuncs.Flag
	// Renders the Lucide icon 'flag-off'.
	FlagOff = templFuncs.FlagOff
	// Renders the Lucide icon 'flag-triangle-left'.
	FlagTriangleLeft = templFuncs.FlagTriangleLeft
	// Renders the Lucide icon 'flag-triangle-right'.
	FlagTriangleRight = templFuncs.FlagTriangleRight
	// Renders the Lucide icon 'flame'.
	Flame = templFuncs.Flame
	// Renders the Lucide icon 'flame-kindling'.
	FlameKindling = templFuncs.FlameKindling
	// Renders the Lucide icon 'flashlight'.
	Flashlight = templFuncs.Flashlight
	// Renders the Lucide icon 'flashlight-off'.
	FlashlightOff = templFuncs.FlashlightOff
	// Renders the Lucide icon 'flask-conical'.
	FlaskConical = templFuncs.FlaskConical
	// Renders the Lucide icon 'flask-conical-off'.
	FlaskConicalOff = templFuncs.FlaskConicalOff
	// Renders the Lucide icon 'flask-round'.
	FlaskRound = templFuncs.FlaskRound
	// Renders the Lucide icon 'flip-horizontal'.
	FlipHorizontal = templFuncs.FlipHorizontal
	// Renders the Lucide icon 'flip-horizontal-2'.
	FlipHorizontal2 = templFuncs.FlipHorizontal2
	// Renders the Lucide icon 'flip-vertical'.
	FlipVertical = templFuncs.FlipVertical
	// Renders the Lucide icon 'flip-vertical-2'.
	FlipVertical2 = templFuncs.FlipVertical2
	// Renders the Lucide icon 'flower'.
	Flower = templFuncs.Flower
	// Renders the Lucide icon 'flower-2'.
	Flower2 = templFuncs.Flower2
	// Renders the Lucide icon 'focus'.
	Focus = templFuncs.Focus
	// Renders the Lucide icon 'fold-horizontal'.
	FoldHorizontal = templFuncs.FoldHorizontal
	// Renders the Lucide icon 'fold-vertical'.
	FoldVertical = templFuncs.FoldVertical
	// Renders the Lucide icon 'folder'.
	Folder = templFuncs.Folder
	// Renders the Lucide icon 'folder-archive'.
	FolderArchive = templFuncs.FolderArchive
	// Renders the Lucide icon 'folder-check'.
	FolderCheck = templFuncs.FolderCheck
	// Renders the Lucide icon 'folder-clock'.
	...
	FolderCog2 = templFuncs.FolderCog
	// Renders the Lucide icon 'folder-dot'.
	...
	FolderGit2 = templFuncs.FolderGit2
	// Renders the Lucide icon 'folder-heart'.
	FolderHeart = templFuncs.FolderHeart
	// Renders the Lucide icon 'folder-input'.
	FolderInput = templFuncs.FolderInput
	// Renders the Lucide icon 'folder-kanban'.
	FolderKanban = templFuncs.FolderKanban
	// Renders the Lucide icon 'folder-key'.
	FolderKey = templFuncs.FolderKey
	// Renders the Lucide icon 'folder-lock'.
	FolderLock = templFuncs.FolderLock
	// Renders the Lucide icon 'folder-minus'.
	FolderMinus = templFuncs.FolderMinus
	// Renders the Lucide icon 'folder-open'.
	FolderOpen = templFuncs.FolderOpen
	// Renders the Lucide icon 'folder-open-dot'.
	...
	FolderRoot = templFuncs.FolderRoot
	// Renders the Lucide icon 'folder-search'.
	FolderSearch = templFuncs.FolderSearch
	// Renders the Lucide icon 'folder-search-2'.
	FolderSearch2 = templFuncs.FolderSearch2
	// Renders the Lucide icon 'folder-symlink'.
	FolderSymlink = templFuncs.FolderSymlink
	// Renders the Lucide icon 'folder-sync'.
	FolderSync = templFuncs.FolderSync
	// Renders the Lucide icon 'folder-tree'.
	FolderTree = templFuncs.FolderTree
	// Renders the Lucide icon 'folder-up'.
	FolderUp = templFuncs.FolderUp
	// Renders the Lucide icon 'folder-x'.
	FolderX = templFuncs.FolderX
	// Renders the Lucide icon 'folders'.
	...
	Frame = templFuncs.Frame
	// Renders the Lucide icon 'framer'.
	Framer = templFuncs.Framer
	// Renders the Lucide icon 'frown'.
	Frown = templFuncs.Frown
	// Renders the Lucide icon 'fuel'.
	...
	GalleryHorizontalEnd = templFuncs.GalleryHorizontalEnd
	// Renders the Lucide icon 'gallery-thumbnails'.
	GalleryThumbnails = templFuncs.GalleryThumbnails
	// Renders the Lucide icon 'gallery-vertical'.
	GalleryVertical = templFuncs.GalleryVertical
	// Renders the Lucide icon 'gallery-vertical-end'.
	GalleryVerticalEnd = templFuncs.GalleryVerticalEnd
	// Renders the Lucide icon 'gamepad'.
	...
	Gem = templFuncs.Gem
	// Renders the Lucide icon 'ghost'.
	Ghost = templFuncs.Ghost
	// Renders the Lucide icon 'gift'.
	Gift = templFuncs.Gift
	// Renders the Lucide icon 'git-branch'.
	GitBranch = templFuncs.GitBranch
	// Renders the Lucide icon 'git-branch-plus'.
	GitBranchPlus = templFuncs.GitBranchPlus
	// Alias for 'GitCommitHorizontal'(git-commit-horizontal).Renders the Lucide icon 'git-commit'
	GitCommit = templFuncs.GitCommitHorizontal
	// Renders the Lucide icon 'git-commit-horizontal'.
	GitCommitHorizontal = templFuncs.GitCommitHorizontal
	// Renders the Lucide icon 'git-commit-vertical'.
	GitCommitVertical = templFuncs.GitCommitVertical
	// Renders the Lucide icon 'git-compare'.
	GitCompare = templFuncs.GitCompare
	// Renders the Lucide icon 'git-compare-arrows'.
	GitCompareArrows = templFuncs.GitCompareArrows
	// Renders the Lucide icon 'git-fork'.
	GitFork = templFuncs.GitFork
	// Renders the Lucide icon 'git-graph'.
	GitGraph = templFuncs.GitGraph
	// Renders the Lucide icon 'git-merge'.
	GitMerge = templFuncs.GitMerge
	// Renders the Lucide icon 'git-pull-request'.
	GitPullRequest = templFuncs.GitPullRequest
	// Renders the Lucide icon 'git-pull-request-arrow'.
	GitPullRequestArrow = templFuncs.GitPullRequestArrow
	// Renders the Lucide icon 'git-pull-request-closed'.
	GitPullRequestClosed = templFuncs.GitPullRequestClosed
	// Renders the Lucide icon 'git-pull-request-create'.
	GitPullRequestCreate = templFuncs.GitPullRequestCreate
	// Renders the Lucide icon 'git-pull-request-create-arrow'.
	GitPullRequestCreateArrow = templFuncs.GitPullRequestCreateArrow
	// Renders the Lucide icon 'git-pull-request-draft'.
	GitPullRequestDraft = templFuncs.GitPullRequestDraft
	// Renders the Lucide icon 'github'.
	Github = templFuncs.Github
	// Renders the Lucide icon 'gitlab'.
	Gitlab = templFuncs.Gitlab
	// Renders the Lucide icon 'glass-water'.
	GlassWater = templFuncs.GlassWater
	// Renders the Lucide icon 'glasses'.
	...
	Grab = templFuncs.Grab
	// Renders the Lucide icon 'graduation-cap'.
	GraduationCap = templFuncs.GraduationCap
	// Renders the Lucide icon 'grape'.
	Grape = templFuncs.Grape
	// Alias for 'Grid3X3'(grid-3x3).Renders the Lucide icon 'grid'
	...
	Grip = templFuncs.Grip
	// Renders the Lucide icon 'grip-horizontal'.
	GripHorizontal = templFuncs.GripHorizontal
	// Renders the Lucide icon 'grip-vertical'.
	GripVertical = templFuncs.GripVertical
	// Renders the Lucide icon 'group'.
	...
	HardDriveDownload = templFuncs.HardDriveDownload
	// Renders the Lucide icon 'hard-drive-upload'.
	HardDriveUpload = templFuncs.HardDriveUpload
	// Renders the Lucide icon 'hard-hat'.
	HardHat = templFuncs.HardHat
	// Renders the Lucide icon 'hash'.
	Hash = templFuncs.Hash
	// Renders the Lucide icon 'haze'.
	Haze = templFuncs.Haze
	// Renders the Lucide icon 'hdmi-port'.
	HdmiPort = templFuncs.HdmiPort
	// Renders the Lucide icon 'heading'.
	Heading = templFuncs.Heading
	// Renders the Lucide icon 'heading-1'.
	Heading1 = templFuncs.Heading1
	// Renders the Lucide icon 'heading-2'.
	Heading2 = templFuncs.Heading2
	// Renders the Lucide icon 'heading-3'.
	Heading3 = templFuncs.Heading3
	// Renders the Lucide icon 'heading-4'.
	Heading4 = templFuncs.Heading4
	// Renders the Lucide icon 'heading-5'.
	...
	HeartCrack = templFuncs.HeartCrack
	// Renders the Lucide icon 'heart-handshake'.
	HeartHandshake = templFuncs.HeartHandshake
	// Renders the Lucide icon 'heart-off'.
	...
	ImageDown = templFuncs.ImageDown
	// Renders the Lucide icon 'image-minus'.
	...
	Instagram = templFuncs.Instagram
	// Renders the Lucide icon 'italic'.
	Italic = templFuncs.Italic
	// Renders the Lucide icon 'iteration-ccw'.
	IterationCcw = templFuncs.IterationCcw
	// Renders the Lucide icon 'iteration-cw'.
	IterationCw = templFuncs.IterationCw
	// Renders the Lucide icon 'japanese-yen'.
	JapaneseYen = templFuncs.JapaneseYen
	// Renders the Lucide icon 'joystick'.
	...
	KeyRound = templFuncs.KeyRound
	// Renders the Lucide icon 'key-square'.
	KeySquare = templFuncs.KeySquare
	// Renders the Lucide icon 'keyboard'.
	...
	LampCeiling = templFuncs.LampCeiling
	// Renders the Lucide icon 'lamp-desk'.
	LampDesk = templFuncs.LampDesk
	// Renders the Lucide icon 'lamp-floor'.
	LampFloor = templFuncs.LampFloor
	// Renders the Lucide icon 'lamp-wall-down'.
	LampWallDown = templFuncs.LampWallDown
	// Renders the Lucide icon 'lamp-wall-up'.
	LampWallUp = templFuncs.LampWallUp
	// Renders the Lucide icon 'land-plot'.
	LandPlot = templFuncs.LandPlot
	// Renders the Lucide icon 'landmark'.
	Landmark = templFuncs.Landmark
	// Renders the Lucide icon 'languages'.
	...
	LassoSelect = templFuncs.LassoSelect
	// Renders the Lucide icon 'laugh'.
	Laugh = templFuncs.Laugh
	// Renders the Lucide icon 'layers'.
	...
	LayoutDashboard = templFuncs.LayoutDashboard
	// Renders the Lucide icon 'layout-grid'.
	LayoutGrid = templFuncs.LayoutGrid
	// Renders the Lucide icon 'layout-list'.
	LayoutList = templFuncs.LayoutList
	// Renders the Lucide icon 'layout-panel-left'.
	LayoutPanelLeft = templFuncs.LayoutPanelLeft
	// Renders the Lucide icon 'layout-panel-top'.
	LayoutPanelTop = templFuncs.LayoutPanelTop
	// Renders the Lucide icon 'layout-template'.
	LayoutTemplate = templFuncs.LayoutTemplate
	// Renders the Lucide icon 'leaf'.
	...
	Ligature = templFuncs.Ligature
	// Renders the Lucide icon 'lightbulb'.
	...
	Link2 = templFuncs.Link2
	// Renders the Lucide icon 'link-2-off'.
	Link2Off = templFuncs.Link2Off
	// Renders the Lucide icon 'linkedin'.
	...
	ListMusic = templFuncs.ListMusic
	// Renders the Lucide icon 'list-ordered'.
	ListOrdered = templFuncs.ListOrdered
	// Renders the Lucide icon 'list-plus'.
	ListPlus = templFuncs.ListPlus
	// Renders the Lucide icon 'list-restart'.
	ListRestart = templFuncs.ListRestart
	// Renders the Lucide icon 'list-start'.
	ListStart = templFuncs.ListStart
	// Renders the Lucide icon 'list-todo'.
	ListTodo = templFuncs.ListTodo
	// Renders the Lucide icon 'list-tree'.
	ListTree = templFuncs.ListTree
	// Renders the Lucide icon 'list-video'.
	ListVideo = templFuncs.ListVideo
	// Renders the Lucide icon 'list-x'.
	...
	LocateFixed = templFuncs.LocateFixed
	// Renders the Lucide icon 'locate-off'.
	LocateOff = templFuncs.LocateOff
	// Renders the Lucide icon 'lock'.
	...
	Mail = templFuncs.Mail
	// Renders the Lucide icon 'mail-check'.
	MailCheck = templFuncs.MailCheck
	// Renders the Lucide icon 'mail-minus'.
	MailMinus = templFuncs.MailMinus
	// Renders the Lucide icon 'mail-open'.
	MailOpen = templFuncs.MailOpen
	// Renders the Lucide icon 'mail-plus'.
	MailPlus = templFuncs.MailPlus
	// Renders the Lucide icon 'mail-question'.
	MailQuestion = templFuncs.MailQuestion
	// Renders the Lucide icon 'mail-search'.
	MailSearch = templFuncs.MailSearch
	// Renders the Lucide icon 'mail-warning'.
	MailWarning = templFuncs.MailWarning
	// Renders the Lucide icon 'mail-x'.
	MailX = templFuncs.MailX
	// Renders the Lucide icon 'mailbox'.
	Mailbox = templFuncs.Mailbox
	// Renders the Lucide icon 'mails'.
	Mails = templFuncs.Mails
	// Renders the Lucide icon 'map'.
	Map = templFuncs.Map
	...
	Maximize = templFuncs.Maximize
	// Renders the Lucide icon 'maximize-2'.
	Maximize2 = templFuncs.Maximize2
	// Renders the Lucide icon 'medal'.
	Medal = templFuncs.Medal
	// Renders the Lucide icon 'megaphone'.
	Megaphone = templFuncs.Megaphone
	// Renders the Lucide icon 'megaphone-off'.
	MegaphoneOff = templFuncs.MegaphoneOff
	// Renders the Lucide icon 'meh'.
	Meh = templFuncs.Meh
	// Renders the Lucide icon 'memory-stick'.
	...
	MessageCircle = templFuncs.MessageCircle
	// Renders the Lucide icon 'message-circle-code'.
	MessageCircleCode = templFuncs.MessageCircleCode
	// Renders the Lucide icon 'message-circle-dashed'.
	MessageCircleDashed = templFuncs.MessageCircleDashed
	// Renders the Lucide icon 'message-circle-heart'.
	MessageCircleHeart = templFuncs.MessageCircleHeart
	// Renders the Lucide icon 'message-circle-more'.
	MessageCircleMore = templFuncs.MessageCircleMore
	// Renders the Lucide icon 'message-circle-off'.
	MessageCircleOff = templFuncs.MessageCircleOff
	// Renders the Lucide icon 'message-circle-plus'.
	MessageCirclePlus = templFuncs.MessageCirclePlus
	// Renders the Lucide icon 'message-circle-question'.
	MessageCircleQuestion = templFuncs.MessageCircleQuestion
	// Renders the Lucide icon 'message-circle-reply'.
	MessageCircleReply = templFuncs.MessageCircleReply
	// Renders the Lucide icon 'message-circle-warning'.
	MessageCircleWarning = templFuncs.MessageCircleWarning
	// Renders the Lucide icon 'message-circle-x'.
	MessageCircleX = templFuncs.MessageCircleX
	// Renders the Lucide icon 'message-square'.
	MessageSquare = templFuncs.MessageSquare
	// Renders the Lucide icon 'message-square-code'.
	MessageSquareCode = templFuncs.MessageSquareCode
	// Renders the Lucide icon 'message-square-dashed'.
	MessageSquareDashed = templFuncs.MessageSquareDashed
	// Renders the Lucide icon 'message-square-diff'.
	MessageSquareDiff = templFuncs.MessageSquareDiff
	// Renders the Lucide icon 'message-square-dot'.
	...
	MessageSquareOff = templFuncs.MessageSquareOff
	// Renders the Lucide icon 'message-square-plus'.
	MessageSquarePlus = templFuncs.MessageSquarePlus
	// Renders the Lucide icon 'message-square-quote'.
	MessageSquareQuote = templFuncs.MessageSquareQuote
	// Renders the Lucide icon 'message-square-reply'.
	MessageSquareReply = templFuncs.MessageSquareReply
	// Renders the Lucide icon 'message-square-share'.
	MessageSquareShare = templFuncs.MessageSquareShare
	// Renders the Lucide icon 'message-square-text'.
	MessageSquareText = templFuncs.MessageSquareText
	// Renders the Lucide icon 'message-square-warning'.
	MessageSquareWarning = templFuncs.MessageSquareWarning
	// Renders the Lucide icon 'message-square-x'.
	MessageSquareX = templFuncs.MessageSquareX
	// Renders the Lucide icon 'messages-square'.
	...
	Microwave = templFuncs.Microwave
	// Renders the Lucide icon 'milestone'.
	Milestone = templFuncs.Milestone
	// Renders the Lucide icon 'milk'.
	Milk = templFuncs.Milk
	// Renders the Lucide icon 'milk-off'.
	MilkOff = templFuncs.MilkOff
	// Renders the Lucide icon 'minimize'.
	Minimize = templFuncs.Minimize
	// Renders the Lucide icon 'minimize-2'.
	...
	MonitorDown = templFuncs.MonitorDown
	// Renders the Lucide icon 'monitor-off'.
	MonitorOff = templFuncs.MonitorOff
	// Renders the Lucide icon 'monitor-pause'.
	MonitorPause = templFuncs.MonitorPause
	// Renders the Lucide icon 'monitor-play'.
	MonitorPlay = templFuncs.MonitorPlay
	// Renders the Lucide icon 'monitor-smartphone'.
	MonitorSmartphone = templFuncs.MonitorSmartphone
	// Renders the Lucide icon 'monitor-speaker'.
	MonitorSpeaker = templFuncs.MonitorSpeaker
	// Renders the Lucide icon 'monitor-stop'.
	MonitorStop = templFuncs.MonitorStop
	// Renders the Lucide icon 'monitor-up'.
	MonitorUp = templFuncs.MonitorUp
	// Renders the Lucide icon 'monitor-x'.
	MonitorX = templFuncs.MonitorX
	// Renders the Lucide icon 'moon'.
	...
	Move3D = templFuncs.Move3D
	// Renders the Lucide icon 'move-diagonal'.
	MoveDiagonal = templFuncs.MoveDiagonal
	// Renders the Lucide icon 'move-diagonal-2'.
	MoveDiagonal2 = templFuncs.MoveDiagonal2
	// Renders the Lucide icon 'move-down'.
	MoveDown = templFuncs.MoveDown
	// Renders the Lucide icon 'move-down-left'.
	MoveDownLeft = templFuncs.MoveDownLeft
	// Renders the Lucide icon 'move-down-right'.
	MoveDownRight = templFuncs.MoveDownRight
	// Renders the Lucide icon 'move-horizontal'.
	MoveHorizontal = templFuncs.MoveHorizontal
	// Renders the Lucide icon 'move-left'.
	MoveLeft = templFuncs.MoveLeft
	// Renders the Lucide icon 'move-right'.
	MoveRight = templFuncs.MoveRight
	// Renders the Lucide icon 'move-up'.
	MoveUp = templFuncs.MoveUp
	// Renders the Lucide icon 'move-up-left'.
	MoveUpLeft = templFuncs.MoveUpLeft
	// Renders the Lucide icon 'move-up-right'.
	MoveUpRight = templFuncs.MoveUpRight
	// Renders the Lucide icon 'move-vertical'.
	MoveVertical = templFuncs.MoveVertical
	// Renders the Lucide icon 'music'.
	Music = templFuncs.Music
	// Renders the Lucide icon 'music-2'.
	Music2 = templFuncs.Music2
	// Renders the Lucide icon 'music-3'.
	Music3 = templFuncs.Music3
	// Renders the Lucide icon 'music-4'.
	Music4 = templFuncs.Music4
	// Renders the Lucide icon 'navigation'.
	Navigation = templFuncs.Navigation
	// Renders the Lucide icon 'navigation-2'.
	Navigation2 = templFuncs.Navigation2
	// Renders the Lucide icon 'navigation-2-off'.
	Navigation2Off = templFuncs.Navigation2Off
	// Renders the Lucide icon 'navigation-off'.
	NavigationOff = templFuncs.NavigationOff
	// Renders the Lucide icon 'network'.
	Network = templFuncs.Network
	// Renders the Lucide icon 'newspaper'.
	...
	Package2 = templFuncs.Package2
	// Renders the Lucide icon 'package-check'.
	PackageCheck = templFuncs.PackageCheck
	// Renders the Lucide icon 'package-minus'.
	PackageMinus = templFuncs.PackageMinus
	// Renders the Lucide icon 'package-open'.
	PackageOpen = templFuncs.PackageOpen
	// Renders the Lucide icon 'package-plus'.
	PackagePlus = templFuncs.PackagePlus
	// Renders the Lucide icon 'package-search'.
	PackageSearch = templFuncs.PackageSearch
	// Renders the Lucide icon 'package-x'.
	...
	PanelBottomClose = templFuncs.PanelBottomClose
	// Renders the Lucide icon 'panel-bottom-dashed'.
	PanelBottomDashed = templFuncs.PanelBottomDashed
	// Alias for 'PanelBottomDashed'(panel-bottom-dashed).Renders the Lucide icon 'panel-bottom-inactive'
	PanelBottomInactive = templFuncs.PanelBottomDashed
	// Renders the Lucide icon 'panel-bottom-open'.
	PanelBottomOpen = templFuncs.PanelBottomOpen
	// Renders the Lucide icon 'panel-left'.
	PanelLeft = templFuncs.PanelLeft
	// Renders the Lucide icon 'panel-left-close'.
	PanelLeftClose = templFuncs.PanelLeftClose
	// Renders the Lucide icon 'panel-left-dashed'.
	PanelLeftDashed = templFuncs.PanelLeftDashed
	// Alias for 'PanelLeftDashed'(panel-left-dashed).Renders the Lucide icon 'panel-left-inactive'
	PanelLeftInactive = templFuncs.PanelLeftDashed
	// Renders the Lucide icon 'panel-left-open'.
	PanelLeftOpen = templFuncs.PanelLeftOpen
	// Renders the Lucide icon 'panel-right'.
	PanelRight = templFuncs.PanelRight
	// Renders the Lucide icon 'panel-right-close'.
	PanelRightClose = templFuncs.PanelRightClose
	// Renders the Lucide icon 'panel-right-dashed'.
	PanelRightDashed = templFuncs.PanelRightDashed
	// Alias for 'PanelRightDashed'(panel-right-dashed).Renders the Lucide icon 'panel-right-inactive'
	PanelRightInactive = templFuncs.PanelRightDashed
	// Renders the Lucide icon 'panel-right-open'.
	PanelRightOpen = templFuncs.PanelRightOpen
	// Renders the Lucide icon 'panel-top'.
	PanelTop = templFuncs.PanelTop
	// Renders the Lucide icon 'panel-top-close'.
	PanelTopClose = templFuncs.PanelTopClose
	// Renders the Lucide icon 'panel-top-dashed'.
	PanelTopDashed = templFuncs.PanelTopDashed
	// Alias for 'PanelTopDashed'(panel-top-dashed).Renders the Lucide icon 'panel-top-inactive'
	PanelTopInactive = templFuncs.PanelTopDashed
	// Renders the Lucide icon 'panel-top-open'.
	PanelTopOpen = templFuncs.PanelTopOpen
	// Renders the Lucide icon 'panels-left-bottom'.
	PanelsLeftBottom = templFuncs.PanelsLeftBottom
	// Alias for 'Columns3'(columns-3).Renders the Lucide icon 'panels-left-right'
	PanelsLeftRight = templFuncs.Columns3
	// Renders the Lucide icon 'panels-right-bottom'.
	PanelsRightBottom = templFuncs.PanelsRightBottom
	// Alias for 'Rows3'(rows-3).Renders the Lucide icon 'panels-top-bottom'
	PanelsTopBottom = templFuncs.Rows3
	// Renders the Lucide icon 'panels-top-left'.
	PanelsTopLeft = templFuncs.PanelsTopLeft
	// Renders the Lucide icon 'paperclip'.
	...
	PhoneCall = templFuncs.PhoneCall
	// Renders the Lucide icon 'phone-forwarded'.
	PhoneForwarded = templFuncs.PhoneForwarded
	// Renders the Lucide icon 'phone-incoming'.
	PhoneIncoming = templFuncs.PhoneIncoming
	// Renders the Lucide icon 'phone-missed'.
	PhoneMissed = templFuncs.PhoneMissed
	// Renders the Lucide icon 'phone-off'.
	PhoneOff = templFuncs.PhoneOff
	// Renders the Lucide icon 'phone-outgoing'.
	...
	PinOff = templFuncs.PinOff
	// Renders the Lucide icon 'pipette'.
	Pipette = templFuncs.Pipette
	// Renders the Lucide icon 'pizza'.
	Pizza = templFuncs.Pizza
	// Renders the Lucide icon 'plane'.
	Plane = templFuncs.Plane
	// Renders the Lucide icon 'plane-landing'.
	PlaneLanding = templFuncs.PlaneLanding
	// Renders the Lucide icon 'plane-takeoff'.
	...
	PocketKnife = templFuncs.PocketKnife
	// Renders the Lucide icon 'podcast'.
	Podcast = templFuncs.Podcast
	// Renders the Lucide icon 'pointer'.
	Pointer = templFuncs.Pointer
	// Renders the Lucide icon 'pointer-off'.
	PointerOff = templFuncs.PointerOff
	// Renders the Lucide icon 'popcorn'.
	Popcorn = templFuncs.Popcorn
	// Renders the Lucide icon 'popsicle'.
	Popsicle = templFuncs.Popsicle
	// Renders the Lucide icon 'pound-sterling'.
	...
	Pyramid = templFuncs.Pyramid
	// Renders the Lucide icon 'qr-code'.
	QrCode = templFuncs.QrCode
	// Renders the Lucide icon 'quote'.
	Quote = templFuncs.Quote
	// Renders the Lucide icon 'rabbit'.
	Rabbit = templFuncs.Rabbit
	// Renders the Lucide icon 'radar'.
	...
	RadioReceiver = templFuncs.RadioReceiver
	// Renders the Lucide icon 'radio-tower'.
	RadioTower = templFuncs.RadioTower
	// Renders the Lucide icon 'radius'.
	Radius = templFuncs.Radius
	// Renders the Lucide icon 'rail-symbol'.
	RailSymbol = templFuncs.RailSymbol
	// Renders the Lucide icon 'rainbow'.
	Rainbow = templFuncs.Rainbow
	// Renders the Lucide icon 'rat'.
	Rat = templFuncs.Rat
	// Renders the Lucide icon 'ratio'.
	...
	RectangleVertical = templFuncs.RectangleVertical
	// Renders the Lucide icon 'recycle'.
	Recycle = templFuncs.Recycle
	// Renders the Lucide icon 'redo'.
	Redo = templFuncs.Redo
	// Renders the Lucide icon 'redo-2'.
	Redo2 = templFuncs.Redo2
	// Renders the Lucide icon 'redo-dot'.
	RedoDot = templFuncs.RedoDot
	// Renders the Lucide icon 'refresh-ccw'.
	RefreshCcw = templFuncs.RefreshCcw
	// Renders the Lucide icon 'refresh-ccw-dot'.
	RefreshCcwDot = templFuncs.RefreshCcwDot
	// Renders the Lucide icon 'refresh-cw'.
	RefreshCw = templFuncs.RefreshCw
	// Renders the Lucide icon 'refresh-cw-off'.
	RefreshCwOff = templFuncs.RefreshCwOff
	// Renders the Lucide icon 'refrigerator'.
	Refrigerator = templFuncs.Refrigerator
	// Renders the Lucide icon 'regex'.
	Regex = templFuncs.Regex
	// Renders the Lucide icon 'remove-formatting'.
	RemoveFormatting = templFuncs.RemoveFormatting
	// Renders the Lucide icon 'repeat'.
	Repeat = templFuncs.Repeat
	// Renders the Lucide icon 'repeat-1'.
	Repeat1 = templFuncs.Repeat1
	// Renders the Lucide icon 'repeat-2'.
	Repeat2 = templFuncs.Repeat2
	// Renders the Lucide icon 'replace'.
	Replace = templFuncs.Replace
	// Renders the Lucide icon 'replace-all'.
	ReplaceAll = templFuncs.ReplaceAll
	// Renders the Lucide icon 'reply'.
	Reply = templFuncs.Reply
	// Renders the Lucide icon 'reply-all'.
	ReplyAll = templFuncs.ReplyAll
	// Renders the Lucide icon 'rewind'.
	Rewind = templFuncs.Rewind
	// Renders the Lucide icon 'ribbon'.
	Ribbon = templFuncs.Ribbon
	// Renders the Lucide icon 'rocket'.
	Rocket = templFuncs.Rocket
	// Renders the Lucide icon 'rocking-chair'.
	RockingChair = templFuncs.RockingChair
	// Renders the Lucide icon 'roller-coaster'.
	RollerCoaster = templFuncs.RollerCoaster
	// Renders the Lucide icon 'rotate-3d'.
	...
	RouteOff = templFuncs.RouteOff
	// Renders the Lucide icon 'router'.
	Router = templFuncs.Router
	// Alias for 'Rows2'(rows-2).Renders the Lucide icon 'rows'
	Rows = templFuncs.Rows2
	// Renders the Lucide icon 'rows-2'.
	Rows2 = templFuncs.Rows2
	// Renders the Lucide icon 'rows-3'.
	Rows3 = templFuncs.Rows3
	// Renders the Lucide icon 'rows-4'.
	Rows4 = templFuncs.Rows4
	// Renders the Lucide icon 'rss'.
	Rss = templFuncs.Rss
	// Renders the Lucide icon 'ruler'.
	Ruler = templFuncs.Ruler
	// Renders the Lucide icon 'russian-ruble'.
	RussianRuble = templFuncs.RussianRuble
	// Renders the Lucide icon 'sailboat'.
	Sailboat = templFuncs.Sailboat
	// Renders the Lucide icon 'salad'.
	Salad = templFuncs.Salad
	// Renders the Lucide icon 'sandwich'.
	Sandwich = templFuncs.Sandwich
	// Renders the Lucide icon 'satellite'.
	Satellite = templFuncs.Satellite
	// Renders the Lucide icon 'satellite-dish'.
	SatelliteDish = templFuncs.SatelliteDish
	// Renders the Lucide icon 'save'.
	...
	Scale3D = templFuncs.Scale3D
	// Renders the Lucide icon 'scaling'.
	Scaling = templFuncs.Scaling
	// Renders the Lucide icon 'scan'.
	Scan = templFuncs.Scan
	// Renders the Lucide icon 'scan-barcode'.
	ScanBarcode = templFuncs.ScanBarcode
	// Renders the Lucide icon 'scan-eye'.
	...
	ScreenShareOff = templFuncs.ScreenShareOff
	// Renders the Lucide icon 'scroll'.
	Scroll = templFuncs.Scroll
	// Renders the Lucide icon 'scroll-text'.
	ScrollText = templFuncs.ScrollText
	// Renders the Lucide icon 'search'.
	Search = templFuncs.Search
	// Renders the Lucide icon 'search-check'.
	SearchCheck = templFuncs.SearchCheck
	// Renders the Lucide icon 'search-code'.
	SearchCode = templFuncs.SearchCode
	// Renders the Lucide icon 'search-slash'.
	...
	SendHorizonal = templFuncs.SendHorizontal
	// Renders the Lucide icon 'send-horizontal'.
	SendHorizontal = templFuncs.SendHorizontal
	// Renders the Lucide icon 'send-to-back'.
	SendToBack = templFuncs.SendToBack
	// Renders the Lucide icon 'separator-horizontal'.
	SeparatorHorizontal = templFuncs.SeparatorHorizontal
	// Renders the Lucide icon 'separator-vertical'.
	SeparatorVertical = templFuncs.SeparatorVertical
	// Renders the Lucide icon 'server'.
	Server = templFuncs.Server
	// Renders the Lucide icon 'server-cog'.
	ServerCog = templFuncs.ServerCog
	// Renders the Lucide icon 'server-crash'.
	ServerCrash = templFuncs.ServerCrash
	// Renders the Lucide icon 'server-off'.
	ServerOff = templFuncs.ServerOff
	// Renders the Lucide icon 'settings'.
	Settings = templFuncs.Settings
	// Renders the Lucide icon 'settings-2'.
	Settings2 = templFuncs.Settings2
	// Renders the Lucide icon 'shapes'.
	Shapes = templFuncs.Shapes
	// Renders the Lucide icon 'share'.
	Share = templFuncs.Share
	// Renders the Lucide icon 'share-2'.
	Share2 = templFuncs.Share2
	// Renders the Lucide icon 'sheet'.
	Sheet = templFuncs.Sheet
	// Renders the Lucide icon 'shell'.
	Shell = templFuncs.Shell
	// Renders the Lucide icon 'shield'.
	Shield = templFuncs.Shield
	// Renders the Lucide icon 'shield-alert'.
	ShieldAlert = templFuncs.ShieldAlert
	// Renders the Lucide icon 'shield-ban'.
	ShieldBan = templFuncs.ShieldBan
	// Renders the Lucide icon 'shield-check'.
	ShieldCheck = templFuncs.ShieldCheck
	// Alias for 'ShieldX'(shield-x).Renders the Lucide icon 'shield-close'
	ShieldClose = templFuncs.ShieldX
	// Renders the Lucide icon 'shield-ellipsis'.
	ShieldEllipsis = templFuncs.ShieldEllipsis
	// Renders the Lucide icon 'shield-half'.
	ShieldHalf = templFuncs.ShieldHalf
	// Renders the Lucide icon 'shield-minus'.
	ShieldMinus = templFuncs.ShieldMinus
	// Renders the Lucide icon 'shield-off'.
	ShieldOff = templFuncs.ShieldOff
	// Renders the Lucide icon 'shield-plus'.
	...
	Ship = templFuncs.Ship
	// Renders the Lucide icon 'ship-wheel'.
	ShipWheel = templFuncs.ShipWheel
	// Renders the Lucide icon 'shirt'.
	Shirt = templFuncs.Shirt
	// Renders the Lucide icon 'shopping-bag'.
	ShoppingBag = templFuncs.ShoppingBag
	// Renders the Lucide icon 'shopping-basket'.
	ShoppingBasket = templFuncs.ShoppingBasket
	// Renders the Lucide icon 'shopping-cart'.
	ShoppingCart = templFuncs.ShoppingCart
	// Renders the Lucide icon 'shovel'.
	...
	Shrub = templFuncs.Shrub
	// Renders the Lucide icon 'shuffle'.
	Shuffle = templFuncs.Shuffle
	// Alias for 'PanelLeft'(panel-left).Renders the Lucide icon 'sidebar'
	Sidebar = templFuncs.PanelLeft
	// Alias for 'PanelLeftClose'(panel-left-close).Renders the Lucide icon 'sidebar-close'
	SidebarClose = templFuncs.PanelLeftClose
	// Alias for 'PanelLeftOpen'(panel-left-open).Renders the Lucide icon 'sidebar-open'
	...
	SignalHigh = templFuncs.SignalHigh
	// Renders the Lucide icon 'signal-low'.
	SignalLow = templFuncs.SignalLow
	// Renders the Lucide icon 'signal-medium'.
	...
	SignpostBig = templFuncs.SignpostBig
	// Renders the Lucide icon 'siren'.
	Siren = templFuncs.Siren
	// Renders the Lucide icon 'skip-back'.
	SkipBack = templFuncs.SkipBack
	// Renders the Lucide icon 'skip-forward'.
	SkipForward = templFuncs.SkipForward
	// Renders the Lucide icon 'skull'.
	Skull = templFuncs.Skull
	// Renders the Lucide icon 'slack'.
	...
	SmartphoneCharging = templFuncs.SmartphoneCharging
	// Renders the Lucide icon 'smartphone-nfc'.
	SmartphoneNfc = templFuncs.SmartphoneNfc
	// Renders the Lucide icon 'smile'.
	Smile = templFuncs.Smile
	// Renders the Lucide icon 'smile-plus'.
	SmilePlus = templFuncs.SmilePlus
	// Renders the Lucide icon 'snail'.
	Snail = templFuncs.Snail
	// Renders the Lucide icon 'snowflake'.
	Snowflake = templFuncs.Snowflake
	// Renders the Lucide icon 'sofa'.
	Sofa = templFuncs.Sofa
	// Alias for 'ArrowUpNarrowWide'(arrow-up-narrow-wide).Renders the Lucide icon 'sort-asc'
	SortAsc = templFuncs.ArrowUpNarrowWide
	// Alias for 'ArrowDownWideNarrow'(arrow-down-wide-narrow).Renders the Lucide icon 'sort-desc'
	SortDesc = templFuncs.ArrowDownWideNarrow
	// Renders the Lucide icon 'soup'.
	Soup = templFuncs.Soup
	// Renders the Lucide icon 'space'.
	Space = templFuncs.Space
	// Renders the Lucide icon 'spade'.
	Spade = templFuncs.Spade
	// Renders the Lucide icon 'sparkle'.
	Sparkle = templFuncs.Sparkle
	// Renders the Lucide icon 'sparkles'.
	Sparkles = templFuncs.Sparkles
	// Renders the Lucide icon 'speaker'.
	Speaker = templFuncs.Speaker
	// Renders the Lucide icon 'speech'.
	Speech = templFuncs.Speech
	// Renders the Lucide icon 'spell-check'.
	SpellCheck = templFuncs.SpellCheck
	// Renders the Lucide icon 'spell-check-2'.
	SpellCheck2 = templFuncs.SpellCheck2
	// Renders the Lucide icon 'spline'.
	...
	Squirrel = templFuncs.Squirrel
	// Renders the Lucide icon 'stamp'.
	Stamp = templFuncs.Stamp
	// Renders the Lucide icon 'star'.
	Star = templFuncs.Star
	// Renders the Lucide icon 'star-half'.
	StarHalf = templFuncs.StarHalf
	// Renders the Lucide icon 'star-off'.
	StarOff = templFuncs.StarOff
	// Alias for 'Sparkles'(sparkles).Renders the Lucide icon 'stars'
	Stars = templFuncs.Sparkles
	// Renders the Lucide icon 'step-back'.
	StepBack = templFuncs.StepBack
	// Renders the Lucide icon 'step-forward'.
	StepForward = templFuncs.StepForward
	// Renders the Lucide icon 'stethoscope'.
	Stethoscope = templFuncs.Stethoscope
	// Renders the Lucide icon 'sticker'.
	...
	StretchHorizontal = templFuncs.StretchHorizontal
	// Renders the Lucide icon 'stretch-vertical'.
	StretchVertical = templFuncs.StretchVertical
	// Renders the Lucide icon 'strikethrough'.
	...
	SunDim = templFuncs.SunDim
	// Renders the Lucide icon 'sun-medium'.
	SunMedium = templFuncs.SunMedium
	// Renders the Lucide icon 'sun-moon'.
	SunMoon = templFuncs.SunMoon
	// Renders the Lucide icon 'sun-snow'.
	SunSnow = templFuncs.SunSnow
	// Renders the Lucide icon 'sunrise'.
	Sunrise = templFuncs.Sunrise
	// Renders the Lucide icon 'sunset'.
	...
	SwitchCamera = templFuncs.SwitchCamera
	// Renders the Lucide icon 'sword'.
	Sword = templFuncs.Sword
	// Renders the Lucide icon 'swords'.
	Swords = templFuncs.Swords
	// Renders the Lucide icon 'syringe'.
	Syringe = templFuncs.Syringe
	// Renders the Lucide icon 'table'.
	...
	TabletSmartphone = templFuncs.TabletSmartphone
	// Renders the Lucide icon 'tablets'.
	Tablets = templFuncs.Tablets
	// Renders the Lucide icon 'tag'.
	Tag = templFuncs.Tag
	// Renders the Lucide icon 'tags'.
	Tags = templFuncs.Tags
	// Renders the Lucide icon 'tally-1'.
	Tally1 = templFuncs.Tally1
	// Renders the Lucide icon 'tally-2'.
	Tally2 = templFuncs.Tally2
	// Renders the Lucide icon 'tally-3'.
	Tally3 = templFuncs.Tally3
	// Renders the Lucide icon 'tally-4'.
	Tally4 = templFuncs.Tally4
	// Renders the Lucide icon 'tally-5'.
	Tally5 = templFuncs.Tally5
	// Renders the Lucide icon 'tangent'.
	...
	Text = templFuncs.Text
	// Renders the Lucide icon 'text-cursor'.
	TextCursor = templFuncs.TextCursor
	// Renders the Lucide icon 'text-cursor-input'.
	...
	TextSelection = templFuncs.TextSelect
	// Renders the Lucide icon 'theater'.
	Theater = templFuncs.Theater
	// Renders the Lucide icon 'thermometer'.
	Thermometer = templFuncs.Thermometer
	// Renders the Lucide icon 'thermometer-snowflake'.
	ThermometerSnowflake = templFuncs.ThermometerSnowflake
	// Renders the Lucide icon 'thermometer-sun'.
	ThermometerSun = templFuncs.ThermometerSun
	// Renders the Lucide icon 'thumbs-down'.
	ThumbsDown = templFuncs.ThumbsDown
	// Renders the Lucide icon 'thumbs-up'.
	...
	TimerOff = templFuncs.TimerOff
	// Renders the Lucide icon 'timer-reset'.
	TimerReset = templFuncs.TimerReset
	// Renders the Lucide icon 'toggle-left'.
	...
	Torus = templFuncs.Torus
	// Renders the Lucide icon 'touchpad'.
	Touchpad = templFuncs.Touchpad
	// Renders the Lucide icon 'touchpad-off'.
	TouchpadOff = templFuncs.TouchpadOff
	// Renders the Lucide icon 'tower-control'.
	TowerControl = templFuncs.TowerControl
	// Renders the Lucide icon 'toy-brick'.
	ToyBrick = templFuncs.ToyBrick
	// Renders the Lucide icon 'tractor'.
	Tractor = templFuncs.Tractor
	// Renders the Lucide icon 'traffic-cone'.
	TrafficCone = templFuncs.TrafficCone
	// Alias for 'TramFront'(tram-front).Renders the Lucide icon 'train'
	Train = templFuncs.TramFront
	// Renders the Lucide icon 'train-front'.
	TrainFront = templFuncs.TrainFront
	// Renders the Lucide icon 'train-front-tunnel'.
	TrainFrontTunnel = templFuncs.TrainFrontTunnel
	// Renders the Lucide icon 'train-track'.
	...
	Trees = templFuncs.Trees
	// Renders the Lucide icon 'trello'.
	Trello = templFuncs.Trello
	// Renders the Lucide icon 'trending-down'.
	...
	Trophy = templFuncs.Trophy
	// Renders the Lucide icon 'truck'.
	Truck = templFuncs.Truck
	// Renders the Lucide icon 'turtle'.
	...
	UmbrellaOff = templFuncs.UmbrellaOff
	// Renders the Lucide icon 'underline'.
	Underline = templFuncs.Underline
	// Renders the Lucide icon 'undo'.
	Undo = templFuncs.Undo
	// Renders the Lucide icon 'undo-2'.
	Undo2 = templFuncs.Undo2
	// Renders the Lucide icon 'undo-dot'.
	UndoDot = templFuncs.UndoDot
	// Renders the Lucide icon 'unfold-horizontal'.
	UnfoldHorizontal = templFuncs.UnfoldHorizontal
	// Renders the Lucide icon 'unfold-vertical'.
	...
	User = templFuncs.User
	// Alias for 'UserRound'(user-round).Renders the Lucide icon 'user-2'
	User2 = templFuncs.UserRound
	// Renders the Lucide icon 'user-check'.
	UserCheck = templFuncs.UserCheck
	// Alias for 'UserRoundCheck'(user-round-check).Renders the Lucide icon 'user-check-2'
	UserCheck2 = templFuncs.UserRoundCheck
	// Alias for 'CircleUser'(circle-user).Renders the Lucide icon 'user-circle'
	UserCircle = templFuncs.CircleUser
	// Alias for 'CircleUserRound'(circle-user-round).Renders the Lucide icon 'user-circle-2'
	UserCircle2 = templFuncs.CircleUserRound
	// Renders the Lucide icon 'user-cog'.
	UserCog = templFuncs.UserCog
	// Alias for 'UserRoundCog'(user-round-cog).Renders the Lucide icon 'user-cog-2'
	UserCog2 = templFuncs.UserRoundCog
	// Renders the Lucide icon 'user-minus'.
	...
	UserPlus2 = templFuncs.UserRoundPlus
	// Renders the Lucide icon 'user-round'.
	UserRound = templFuncs.UserRound
	// Renders the Lucide icon 'user-round-check'.
	UserRoundCheck = templFuncs.UserRoundCheck
	// Renders the Lucide icon 'user-round-cog'.
	...
	UserRoundSearch = templFuncs.UserRoundSearch
	// Renders the Lucide icon 'user-round-x'.
	UserRoundX = templFuncs.UserRoundX
	// Renders the Lucide icon 'user-search'.
	UserSearch = templFuncs.UserSearch
	// Alias for 'SquareUser'(square-user).Renders the Lucide icon 'user-square'
	UserSquare = templFuncs.SquareUser
	// Alias for 'SquareUserRound'(square-user-round).Renders the Lucide icon 'user-square-2'
	UserSquare2 = templFuncs.SquareUserRound
	// Renders the Lucide icon 'user-x'.
	UserX = templFuncs.UserX
	// Alias for 'UserRoundX'(user-round-x).Renders the Lucide icon 'user-x-2'
	UserX2 = templFuncs.UserRoundX
	// Renders the Lucide icon 'users'.
	Users = templFuncs.Users
	// Alias for 'UsersRound'(users-round).Renders the Lucide icon 'users-2'
	Users2 = templFuncs.UsersRound
	// Renders the Lucide icon 'users-round'.
	UsersRound = templFuncs.UsersRound
	// Renders the Lucide icon 'utensils'.
	Utensils = templFuncs.Utensils
	// Renders the Lucide icon 'utensils-crossed'.
	UtensilsCrossed = templFuncs.UtensilsCrossed
	// Renders the Lucide icon 'utility-pole'.
	...
	Vibrate = templFuncs.Vibrate
	// Renders the Lucide icon 'vibrate-off'.
	VibrateOff = templFuncs.VibrateOff
	// Renders the Lucide icon 'video'.
	Video = templFuncs.Video
	// Renders the Lucide icon 'video-off'.
	VideoOff = templFuncs.VideoOff
	// Renders the Lucide icon 'videotape'.
	Videotape = templFuncs.Videotape
	// Renders the Lucide icon 'view'.
	...
	Wheat = templFuncs.Wheat
	// Renders the Lucide icon 'wheat-off'.
	WheatOff = templFuncs.WheatOff
	// Renders the Lucide icon 'whole-word'.
	...
	Zap = templFuncs.Zap
	// Renders the Lucide icon 'zap-off'.
	ZapOff = templFuncs.ZapOff
	// Renders the Lucide icon 'zoom-in'.
	ZoomIn = templFuncs.ZoomIn
	// Renders the Lucide icon 'zoom-out'.
	ZoomOut = templFuncs.ZoomOut
)
